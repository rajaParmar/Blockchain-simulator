    ...
    while time.time()<total_run_time:
        ...
        if mining_started == False:
            ...
            while time.time()<total_run_time:
                ...
                # print("wait time at peer ",end ="")
                # print(peer_id, end = " ")
                # print(wait_time_before_generation)
                ...
                while time.time() < generation_time:
                    ...
                    for block in all_blocks:
                        if block[0][0] in H:
                            if block[2] not in H:
                                # total_blocks_recorded+=1
                                print("block received from adversary")
...
def start_all_clients(total_clients):
    ...
    hashpower = [1/(total_clients+1)  for i in range(total_clients)]
    # hashpower= [0.2,0.4,0.4]
